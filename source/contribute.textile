...
<plain>
$ git fetch upstream
$ git checkout -b <yourtopic> upstream/master
</plain>
...
The easiest way to get started with the guides on OSX is to download and install the "guides pkg":http://guides-pkg.strobeapp.com/Guides-0.6.4.pkg. This will give you the +guides+ executable on your machine, and does not require you to have a C compiler on your computer.
...
* Guides are written in a modified Textile. Fro example,s take a look at existing guides, or some of the "Rails Guides":https://github.com/rails/rails/tree/master/railties/guides/source for some examples
